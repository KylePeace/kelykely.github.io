(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.c541e.js';
        if (jsList) {
    ...
    if (false) {
        (function () {
            ...
            require('src/settings.7eb53.js');
            require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.a0764.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.a0764.js';
